class BoxShadowGenerator{
    ...
    applyRule(){    
        ...
        const shadowRule = `${this.insetRef ?"inset": ""} ${
            this.horizontalRef.value}px ${this.verticalRef.value}px ${
                this.blurRef.value}px ${this.spreadRef.value}px 
    ...
    showRule(){
        rule.innerText = this.currentRule;
        webkitRule.innerText = this.currentRule;
        mozRule.innerText = this.currentRule;
    }
